...
if ( ! class_exists( 'WP_List_Table_Helper' ) ) {
	 ...
	 */
		...
		<h4 class="alert alert-info"><?php _e( 'Manage '.ucwords( $this->plural_label ), $this->textdomain );?><a class='wpgmp_pro_link' target='_blank' href='https://codecanyon.net/item/advanced-google-maps-plugin-for-wordpress/5211638'>Upgrade to Pro</a></h4>
	</div>
