...
* Description             : Back end searches views class.
*/
...
?>                  
                                <a href="javascript:DOPBSPBackEndSearch.add()" class="dopbsp-button dopbsp-add"><span class="dopbsp-info"><?php echo $DOPBSP->text('SEARCHES_ADD_SEARCH_SUBMIT'); ?></span></a>
