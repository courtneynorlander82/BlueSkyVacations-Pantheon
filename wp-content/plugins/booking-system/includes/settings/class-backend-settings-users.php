    ...
    if (!class_exists('DOPBSPBackEndSettingsUsers')){
        class DOPBSPBackEndSettingsUsers extends DOPBSPBackEndSettings{
            ...
            function set($args = array('calendar_id' => 0,
                                       ...
                                       'slug' => '',
                                       'value' => 0)){
                $id = isset($_POST['id']) ? $_POST['id']:$args['id'];
                $slug = isset($_POST['slug']) ? $_POST['slug']:$args['slug'];
                $value = isset($_POST['value']) ? (int)$_POST['value']:(int)$args['value'];
                $calendar_id = isset($_POST['calendar_id']) ? (int)$_POST['calendar_id']:(int)$args['calendar_id'];
